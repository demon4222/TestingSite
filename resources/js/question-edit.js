...
function add_answer_index(){
    let iterator_field = 0;
    let iterator_box = 0;
    let $answer_fields = $('.answer-field');
    let $boxes = $('.is-correct');
    $answer_fields.each(function () {
        let $this = $(this);
        $this.attr('name',"answer["+iterator_field+"][text]");
        iterator_field++;
    })
    $boxes.each(function () {
        let $this = $(this);
        $this.attr('name',"answer["+iterator_box+"][isCorrect]");
        iterator_box++;
    })
}
